  ...
  return (
    <nav className='bg-gray-900 shadow-xl shadow-white text-white flex justify-between items-center px-4 md:h-16'>
      ...
      <div className='relative flex justify-center items-center md:block gap-4' ref={dropdownRef}>
        {session && (
          <>
            <button
              ...
              className="text-white mx-2 bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none 
              focus:ring-blue-300 font-medium rounded-lg text-sm px-2 py-2.5 inline-flex items-center"
              type="button"
            >
              Account
            ...
            <div
              id="dropdown"
              className={`z-10 ${showdropdown ? "" : "hidden"} absolute left-[15px] top-12 bg-white 
        ...
        {session && (
          <button
            className='text-white w-fit bg-gradient-to-br from-purple-600 to-blue-500 hover:bg-gradient-to-bl 
